...
<div class="flex1 lg:w-64 w-13 h-full bg-base-200 fixed overflow-auto">
  <!-- This example requires Tailwind CSS v2.0+ -->
  <div
    class="flex-1 flex flex-col min-h-full border-r border-gray-200 bg-white"
  >
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
      <nav class="-mt-2 flex-1 px-2 bg-white space-y-1" aria-label="Sidebar">
